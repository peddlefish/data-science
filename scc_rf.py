...
def main():
	...
	rfc = RandomForestClassifier(n_estimators=1000,bootstrap=False, n_jobs=-1,min_samples_leaf=2)
	...
	rfc_csv.to_csv('/usr3/graduate/xysunn/walmart/rfc_csv.csv',header=True, index=True,delimiter=',')
